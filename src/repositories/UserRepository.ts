...
export class UserRepository {
  ...
  async create(user: NewUser): Promise<void> {
    try {
      ...
      // race window between that check and this insert; the schema's UNIQUE
      // constraints are the actual source of truth, translated here into
      // the same domain error.
