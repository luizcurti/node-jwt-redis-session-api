...
// Rejecting a token from the wrong issuer/audience blocks it from being
// replayed against a different service that shares the same secret.
const JWT_ISSUER = 'jwt-redis-session-api';
const JWT_AUDIENCE = 'jwt-redis-session-api-clients';
